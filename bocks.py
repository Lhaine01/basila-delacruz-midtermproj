...
width = 400
height = 500
py.display.set_caption('Block Stacking')
...
color = [(32, 41, 121), (38, 49, 148), (46, 58, 176), (53, 67, 203), (60, 76, 231), (99, 112, 236), (138, 148, 241), (177, 183, 245), (216, 219, 250), (236, 237, 253),
...
class Brick:
    ...
    def draw(self):
        py.draw.rect(display, self.color, (self.x, self.y, self.w, self.h))
